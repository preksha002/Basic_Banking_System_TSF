<!-- navbar --> 
      ...
      <a class="navbar-brand" href="index.php" style="color : #C0392B;"><b>TSF BANK</b></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item">
                <a class="nav-link" href="about.php" style="color : #C0392B;"><b>About</b></a>
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="contact.php" style="color : #C0392B;"><b>Contact</b></a>
              </li>
